...
public class ChoosingProductsPage {
	...
	@FindBy(how=How.ID, using="cart_quantity_up_5_19_0_709176")	
	...
	@FindBy(how=How.XPATH, using="//*[@id=\"address_delivery\"]/li[9]/a")	
	protected WebElement btnDeliveryAddress;
	
	@FindBy(how=How.XPATH, using="//*[@id=\"address1\"]")	
	protected WebElement txtNewAddress;
	
	@FindBy(how=How.XPATH, using="//*[@id=\"address2\"]")	
	protected WebElement txtNewAddress2;
	
	@FindBy(how=How.XPATH, using="//*[@id=\"city\"]")	
	protected WebElement txtNewCity;
	
	@FindBy(how=How.XPATH, using="//*[@id=\"id_state\"]")	
	protected WebElement comboBoxNewState;
	
	@FindBy(how=How.XPATH, using="//*[@id=\"postcode\"]")	
	protected WebElement txtNewPostCode;
	
	@FindBy(how=How.XPATH, using="//*[@id=\"phone\"]")	
	protected WebElement txtNewPhone;
	
	@FindBy(how=How.XPATH, using="//*[@id=\"phone_mobile\"]")	
	protected WebElement txtNewMobilePhone;
	
	@FindBy(how=How.XPATH, using="//*[@id=\"other\"]")	
	protected WebElement txtInformation;
	
	@FindBy(how=How.XPATH, using="//*[@id=\"submitAddress\"]")	
	protected WebElement btnSaveNewAddress;
	
	@FindBy(how=How.XPATH, using="//*[@id=\"alias\"]")	
	protected WebElement txtOtherAddress;
	
	@FindBy(how=How.ID, using="list")	
	protected WebElement btnList;
	
	@FindBy(how=How.XPATH, using="//*[@id=\"center_column\"]/ul/li/div/div/div[3]/div/div[2]/a[1]")	
	protected WebElement btnAddCart2;
	
	@FindBy(how=How.XPATH, using="//*[@id=\"layer_cart\"]/div[1]/div[2]/div[4]/a")	
	protected WebElement btnProcessedCheckout2;
	
	@FindBy(how=How.XPATH, using="//*[@id=\"address_invoice\"]/li[9]/a")	
	protected WebElement btnBillingAddress;
	
	@FindBy(how=How.XPATH, using="//*[@id=\"block_top_menu\"]/ul/li[3]/a")	
	protected WebElement btnTshirt;
