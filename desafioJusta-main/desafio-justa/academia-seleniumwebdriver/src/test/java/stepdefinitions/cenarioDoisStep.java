...
@And("altero os dados de cobranca {string}, {string}, {string}, {string}, {string}, {string}, {string}, {string}, {string}")
public void altero_os_dados_de_cobranca(String newAddress, String newAddress2, String newCity, String NewPostCode, String NewPhone, String MobilePhone, String information, String OtherAddress, String leiaPlease) {
